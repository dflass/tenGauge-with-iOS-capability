...
QPen QCPItemPixmap::mainPen() const                                 //returns pen type
{   return mSelected ? mSelectedPen : mPen;}
...
QCPItemTracer::QCPItemTracer(QCustomPlot *parentPlot) :             //Item tracer constructor
  QCPAbstractItem(parentPlot),
  position(createPosition(QLatin1String("position"))),
  mGraph(0)
{
...
void QCPItemTracer::setPen(const QPen &pen)                         //sets pen
{  mPen = pen;}

void QCPItemTracer::setSelectedPen(const QPen &pen)                 //sets selected pen
{  mSelectedPen = pen;}

void QCPItemTracer::setBrush(const QBrush &brush)                   //sets drawing brush
{  mBrush = brush;}

void QCPItemTracer::setSelectedBrush(const QBrush &brush)           //sets selected brush
{  mSelectedBrush = brush;}

void QCPItemTracer::setSize(double size)                            //sets size
{  mSize = size;}

void QCPItemTracer::setStyle(QCPItemTracer::TracerStyle style)      //sets style
{  mStyle = style;}


void QCPItemTracer::setGraph(QCPGraph *graph)                       //sets graph tracer is on
{
  if (graph)
  {
...
void QCPItemTracer::setGraphKey(double key)                         //sets graphkey
{  mGraphKey = key;}

void QCPItemTracer::setInterpolating(bool enabled)                  //enables/disables interpolating
...
QPen QCPItemTracer::mainPen() const                                 //returns pen
{   return mSelected ? mSelectedPen : mPen;}

QBrush QCPItemTracer::mainBrush() const                             //returns brush
{   return mSelected ? mSelectedBrush : mBrush;}
...
QCPItemBracket::QCPItemBracket(QCustomPlot *parentPlot) :           //bracket constructor
  QCPAbstractItem(parentPlot),
...
void QCPItemBracket::setPen(const QPen &pen)                            //sets pen to draw bracket
{   mPen = pen;}

void QCPItemBracket::setSelectedPen(const QPen &pen)                    //sets selected pen to draw bracket
{   mSelectedPen = pen;}

void QCPItemBracket::setLength(double length)                           //sets length
{  mLength = length;}

void QCPItemBracket::setStyle(QCPItemBracket::BracketStyle style)       //sets bracket style
{  mStyle = style;}
...
QPen QCPItemBracket::mainPen() const                //Returns pen used to draw lines
{
    return mSelected ? mSelectedPen : mPen;
}
